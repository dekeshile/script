#先把 interface 上的水分子挑出来，会生成renum_bind_site.pdb
...
cd /home/wurp/workspace/antibody/7B27
...
#在这一步做 index , 原来的HOH分离出来做HOH, SOL里不包含HOH的部分做SOL

gmx grompp -f ../../mdp/ions.mdp -c solv.gro -p topol.top -o ions.tpr -maxwarn 1 

gmx genion -s ions.tpr -o solv_ions.gro -p topol.top -pname NA -nname CL -neutral -conc 0.15  -n index.ndx
